...
{
	public class TheCurseSlime : ModProjectile
	{
		public bool FadedIn {
		...
		public override void SetDefaults() {
			...
			Projectile.aiStyle = -1; // use the boss immunity cooldown counter, to prevent ignoring boss attacks by taking damage from other sources
		}
