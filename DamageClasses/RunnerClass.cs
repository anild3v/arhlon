...
namespace Arhlon.DamageClasses
{
	public class RunnerClass : DamageClass
	{
		...
		public override StatInheritanceData GetModifierInheritance(DamageClass damageClass) {
			...
			if (damageClass == DamageClass.Ranged)
				return new StatInheritanceData(
					damageInheritance: 0.15f,
					critChanceInheritance: 0.4f,
		...
		public override void SetStaticDefaults() {
			ClassName.SetDefault("running damage");
		}
		...
		public override void SetDefaultStats(Player player) {
			...
			player.GetCritChance<RunnerClass>() += 4;
			player.GetArmorPenetration<RunnerClass>() += 10;
